...
const CollectionImage = ({ node }) => {
  ...
  const onError = (e) => {
    return <img className='collectionImage'>e.currentTarget.src = 'https://static.toiimg.com/thumb/msid-67586673,width-800,height-600,resizemode-75,imgsize-3918697,pt-32,y_pad-40/67586673.jpg'</img> 
  }
